                            ...
                            <div className="flex flex-col gap-3 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 bg-blue-600 hover:bg-blue-500 text-white py-2 rounded text-sm font-bold shadow-lg shadow-blue-900/20 disabled:opacity-50"
                                    >
                                        {isAuthLoading ? '...' : '登入'}
                                    </button>
                                    <button
                                        ...
                                        disabled={isAuthLoading}
                                        className="flex-1 bg-zinc-800 hover:bg-zinc-700 text-white py-2 rounded text-sm border border-zinc-700 disabled:opacity-50"
                                    >
                                        註冊
                                    </button>
                                </div>
                                ...
                                <div className="relative flex py-1 items-center">
                                    ...
                                    <span className="flex-shrink mx-2 text-zinc-600 text-[10px]">OR</span>
                                    <div className="flex-grow border-t border-zinc-800"></div>
                                </div>

                                <button onClick={login} className="w-full py-2 bg-white text-black font-bold rounded-lg text-sm flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex-1 flex flex-col bg-zinc-900 relative min-h-0">
                        ...
                        <div className="flex flex-col border-b border-zinc-800 bg-zinc-900/50 backdrop-blur z-10">
                            {user ? (
                                ...
                                <div className="p-4 flex items-center justify-between gap-4 bg-zinc-900/80">
                                    <span className="text-sm text-zinc-500">
                                        登入後即可{activeTab === 'public' ? "發布棋譜到公共區域" : "儲存私人棋譜"}
                                    </span>
                                    <button onClick={login} className="px-4 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-sm rounded-lg transition-colors">
                                        Google 登入
                                    </button>
                                </div>
                            )}
